...
//http://localhost:8080/allowance/create
...
//http://localhost:8080/allowance/read
//Read data from the database
//Display recoords of all the allowance
router.route("/read").get((req, res) => {

    Allowance.find().then((allowances) => {
        res.json(allowances);
    }).catch((err) => {
        console.log(err);
    })
...
//http://localhost:8080/allowance/read/id
//Read data from the database
...
//http://localhost:8080/allowance/update/id
//Update one record

...
//http://localhost:8080/ordinaryemployee/create
...
//http://localhost:8080/ordinaryemployee/read
//Read data from the database
//Display records of all ordinaryemployees
router.route("/read").get((req, res) => {

    OrdinaryEmployee.find().then((ordinaryemployees) => {
...
//http://localhost:8080/ordinaryemployee/read/id
//Read data from the database
...
//http://localhost:8080/ordinaryemployee/update/id
//Update one record
router.route("/update/:id").put(async (req, res) => {
    ...
    const update = await OrdinaryEmployee.findByIdAndUpdate(userId, updateOrdinaryEmployee)
    .then(() => {
...
//http://localhost:8080/ordinaryemployee/delete/id
//Delete one record

...
//http://localhost:8080/invoice/create
...
//http://localhost:8080/invoice/read
...
//http://localhost:8080/invoice/read/id
//Read data from the database
...
router.route("/read/:id").get(async (req, res) => {
    ...
    .then((invoice) => {
        ...
        res.status(500).send({status: "Error with fetching invoice", error: err.message});
    })
})

//http://localhost:8080/invoice/update/id
//Update one record
...
//http://localhost:8080/invoice/delete/id
//Delete one record
router.route("/delete/:id").delete(async (req, res) => {
    ...
    .then(() => {
        ...
        console.log(err.message);
        res.status(500).send({status: "Error with deleting invoice", error: err.message});
    })
})

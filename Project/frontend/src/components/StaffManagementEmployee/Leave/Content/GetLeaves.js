    ...
    <div>
      ...
      >
                    ...
                    <tr key={val._id} onChange={changeColor(val.status)}>
                      ...
                      <td>
                        <a
                          ...
                          href={`/Staff/staffManagementEmployee/leave/getLeave/${val._id}`}
                      ...
                      <td>
                        ...
                        {val.status === "Pending" && (
                          <a
                            ...
                            // href={`/Staff/staffManagementEmployee/leave/editLeave/${val._id}`}
        ...
        <button className="btn btn-success">
          <a
            href="/Staff/staffManagementEmployee/leave/createLeave"
